...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<com.example.ohdiary.Diary> diariesList;
    private com.example.ohdiary.DiaryAdapter diaryAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.getMenu().getItem(0).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if(firebaseUser!=null){
                    mAuth.signOut();
                    Intent intent=new Intent(getApplicationContext(), com.example.ohdiary.LoginActivity.class);
        ...
        addDiaryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(firebaseUser!=null){
                    startActivity(new Intent(getApplicationContext(), com.example.ohdiary.AddDiary.class));
                }
            }
        });
    }
    private void getDiaries(String userId){
        ...
        diaryAdapter=new com.example.ohdiary.DiaryAdapter(getApplicationContext(), diariesList);
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    for(DataSnapshot snap:snapshot.getChildren()){
                        com.example.ohdiary.Diary diary=snap.getValue(com.example.ohdiary.Diary.class);
